...
@Properties({
        ...
        @Property(key = LEAN_AGGREGATED_TEST_JUNIT_INTEGRATION_TEST_PATTERNS, name = "JUnit Component/API/Integration TestCase (regex)patterns", defaultValue = "^IT.*$,^API_.*$,^CT.*$"),
        ...
        @Property(key = LEAN_AGGREGATED_TEST_CUCUMBER_INTEGRATION_TEST_TAGS, name = "Cucumber Component/API/Integration test tags(@)", defaultValue = "@api_test,@integration_test,@component_test"),
        ...
        @Property(key = LEAN_AGGREGATED_TEST_GAUGE_INTEGRATION_TEST_TAGS, name = "Gauge Component/API/Integration test tags", defaultValue = "api_test,integration_test,component_test"),
